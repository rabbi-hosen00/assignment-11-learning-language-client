...
const NavBar = () => {
    ...
    return (
        <nav className="bg-gray-500 text-white   mx-auto py-4 px-24 flex items-center justify-between  fixed top-0  left-0 w-full shadow-md z-50 backdrop-blur-3xl bg-gray-500/70">
