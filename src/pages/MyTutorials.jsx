...
const MyTutorials = () => {
  ...
  // Re-apply sorting after changes
  useEffect(() => {
    ...
    <div className="container mx-auto p-4 mt-16 mb-5">
      ...
      <div className="flex justify-end mb-4 gap-2">
        ...
        <button
          ...
          className={`px-4 py-2 rounded ${sortOrder === 'desc' ? 'bg-red-500 text-white' : 'bg-gray-200'}`}
        >
          Sort by Price ↓
        </button>
      ...
      {loading ? (
        <div className="text-center">
          <div className="border-t-transparent border-solid animate-spin rounded-full border-blue-500 border-4 h-12 w-12 mx-auto"></div>
          <p>Loading...</p>
        </div>
      ) : (
        <div className="overflow-x-auto">
